...
class RegistrationControllerTest {
    ...
    void shouldReturnCreatedWhenRegisterPassed() throws Exception {
        ...
        assertTrue(passwordEncoder.matches(registerDto.getPassword(), newUser.getPassword()));
        assertEquals(newUser.getFirstName(), registerDto.getFirstName());
        assertEquals(newUser.getLastName(), registerDto.getLastName());
        assertEquals(newUser.getPhone(), registerDto.getPhone());
        assertEquals(newUser.getRole(), registerDto.getRole());
    }
}